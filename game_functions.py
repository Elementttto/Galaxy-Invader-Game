...
def check_play_button(ai_settings, screen, stats, sb, play_button, ship,
        ...
        # Hide the mouse cursor.
         ...
         stats.reset_stats()
         stats.game_active = True
         # To reset all score and highscore and level and stuff
         sb.prep_score()
         sb.prep_high_score()
         sb.prep_level()
         sb.prep_ships()
...
def update_screen(ai_settings, screen, ship, aliens, sb,bullets,stats,play_button):
...
def check_bullet_alien_collisions(ai_settings, screen, stats, sb, ship, aliens, bullets):
   ...
   # If so, get rid of the bullet and the 
   #if you want to make a high powered bullet which will clear the whole column(high pow
   #ered bullet) the next line should read ascollisions = pygame.sprite.groupcollide(bullets, aliens, False, True)
